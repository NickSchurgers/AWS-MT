...
Execute unit tests
```
    cd "MainTrade.DiscordNotificationLambda/test/MainTrade.DiscordNotificationLambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "MainTrade.DiscordNotificationLambda/src/MainTrade.DiscordNotificationLambda"
