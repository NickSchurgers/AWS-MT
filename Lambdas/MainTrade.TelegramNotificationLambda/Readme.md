...
Execute unit tests
```
    cd "MainTrade.TelegramNotificationLambda/test/MainTrade.TelegramNotificationLambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "MainTrade.TelegramNotificationLambda/src/MainTrade.TelegramNotificationLambda"
